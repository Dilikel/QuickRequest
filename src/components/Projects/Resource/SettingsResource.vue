...
const resource_url = `${import.meta.env.VITE_API_URL}/projects/${props.id}/resource/${props.resourceId}`;
    ...
    <div class="modal-content">
      ...
      <div class="create-header">
        ...
        <div class="header-action">
          <h3>Выберете способ редактирования JSON для вашего ресурса</h3>
            ...
            <div class="additional-params">
              ...
              >
                <input
                    ...
                    @input="updateAdditionalParam(index, key, $event.target.value)"
                />
                <button
